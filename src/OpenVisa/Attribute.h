...
public:
    ...
    [[nodiscard]] unsigned int baudRate() const;
    void setDataBits(DataBits bits);
    [[nodiscard]] DataBits dataBits() const;
    void setFlowControl(FlowControl fc);
    [[nodiscard]] FlowControl flowControl() const;
    void setParity(Parity p);
    [[nodiscard]] Parity parity() const;
    void setStopBits(StopBits bits);
    [[nodiscard]] StopBits stopBits() const;
